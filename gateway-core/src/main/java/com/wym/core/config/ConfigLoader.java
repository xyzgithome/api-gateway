...
import com.wym.common.utils.PropertiesUtils;
...
public class ConfigLoader {
    ...
    private void loadFromArgs(String[] args) {
        ...
        PropertiesUtils.properties2Object(properties, config, StringUtils.EMPTY);
    }
    ...
    private void loadFromConfigFile() {
        ...
        try {
            ...
            try {
                ...
                log.error("load config file close input stream error:", e);
            }
        }
    }
}
